...
<head>
  ...
  <link rel="stylesheet" href="css/clubcontact.css">
...
<body style="background-color: #D0BCA1;">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark stroke">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav ml-lg-auto">
              ...
              <li class="nav-item"><a class="nav-link" href="main.html">Clubs</a></li>
              <li class="nav-item"><a class="nav-link" href="main.html">News</a></li>
  ...
  <section class="w3l-about-breadcrumb text-center">
    <div class="breadcrumb-bg breadcrumb-bg-about py-5" style="background: url(image/apaji-lights.jpeg);">
      ...
      <div>
        <div class="contact-form">
          <form  method="post" onsubmit="sendmail(); reset(); return false;">
            <div class="formm">
              <h3 class="text-center">Want to be part of the community ?</h3>
              <div class="form-top">
                ...
                <div class="form-top-left">
                  ...
                  <input type="number" name="Phone" id="Phone" placeholder="Phone number" required><br>
                </div>
                <div class="form-top-righ">
                  <textarea name="Remark" id="Remark" placeholder="Remark(If any)"></textarea>
                  <label for="Resume" style="margin-top: rem;">Upload PDF Resume</label>
                  <input type="file" name="Resume" id="Resume" placeholder="Resume" required accept="application/pdf">
                </div>
              </div>
        ...
        <div class="cont-details">
          <div class="cont-top gdsc text-center">
            <br><br>
            <p>GOOGLE DEVELOPERS STUDENTS CLUB</p>
            <br><br><br>
            </div>
          <div class="cont-top gfg text-center">
            <br><br>
            <p>GEEKS FOR GEEKS</p>
            <br><br><br>
          </div>
          <div class="cont-top msc text-center">
            <br><br>
            <p>MICROSOFT STUDENTS CHAPTER</p>
            <br><br><br>            
          </div>
        </div>
      </div>
