...
<div class="courses-details">
								...
								<div>
										<h4>Certificate in English for Conversation (Elementary)</h4>
								</div>
								<div>
									  <h4>Certificate in English for Conversation (Advance)</h4>
							  </div>
							  <div>
								    <h4>Certificate in German for Conversation (Elementary)</h4>
						    </div>
						    <div>
							       <h4>Certificate in German for Conversation (Advanced)</h4>
					      </div>
					      <div>
						         <h4>Certificate in Computer Programming and Applications</h4>
				        </div>
				        <div>
					          <h4>Certificate in Sanskrit</h4>
			          </div>
			          <div>
				            <h4>Certificate in Dance Prathama (Kathak / Manipuri/ Bharatnatyam)</h4>
		            </div>
		            <div>
			              <h4>Certificate in  Dance Madhyama (Kathak / Manipuri/ Bharatnatyam)</h4>
	              </div>
	              <div>
		                 <h4>Certificate in Music Prathama  (Vocal/ Instrumental-Sitar/ Sarod/ Violin/ Guitar/Tabla)</h4>
                </div>
                <div>
	                   <h4>Certificate in Music Madhyama  (Vocal/ Instrumental-Sitar/ Sarod/Violin/ Guitar/Tabla)
											</h4>
                </div>
                <div>
	                   <h4>Certificate in French</h4>
                </div>
                <div>
	                   <h4>Certificate in German</h4>
                </div>
                <div>
	                   <h4>Certificate in IT Localization</h4>
                </div>
                <div>
                   	<h4>Certificate in Statistical Techniques and Applications</h4>
                </div>
                <div>
									  <h4>Certificate in Actuarial Sciences</h4>
						    </div>
								<div>
									  <h4>Certificate in Shibori (Tie & Dye) / Dyeing & Painting/ Surface, Ornamentations/ Block Printing/ Macramé & Knotting
											</h4>
							  </div>
                <div>
									<h4>Certificate in E-Commerce</h4>
                </div>
								<div>
									<h4>Certificate in Radio Production (RJing & Anchoring)</h4>
                </div>
								<div>
									<h4>Certificate in Android Application Development</h4>
                </div>
								<div>
									<h4>Certificate Course in Molecular Modelling and Drug Designing</h4>
                </div>
								<div>
									<h4>Diploma in Sanskrit</h4>
                </div>
								<div>
									<h4>Diploma in French</h4>
                </div>
								<div>
									<h4>Diploma in German</h4>
                </div>
								<div>
									<h4>Diploma in Computer Hardware & Maintenance</h4>
                </div>
								<div>
									<h4>Diploma in Internet and Web Applications</h4>
                </div>
								<div>
									<h4>Diploma in Actuarial Sciences</h4>
                </div>
								<div>
									<h4>Diploma in Dance(Uttama)</h4>
                </div>
								<div>
									<h4>
										Diploma in Dance (Nishnat)</h4>
                </div>
								<div>
									<h4>Diploma in Music (Visharad)</h4>
                </div>
								<div>
									<h4>Diploma in Audio Engineering</h4>
                </div>
								<div>
									<h4>Diploma in Broadcast journalism</h4>
                </div>
								<div>
									<h4>Diploma in DOTNET (C#, ASP, NET)</h4>
                </div>
								<div>
									<h4>Diploma in Medical Image Processing</h4>
                </div>
								<div>
									<h4>Diploma in Archival Studies and Records Management</h4>
                </div>
								<div>
									<h4>Diploma in Computational Biology</h4>
                </div>
								<div>
									<h4>Post-graduate Diploma in Women and Human Rights</h4>
                </div>
								<div>
									<h4>Advanced Diploma in Medical Image Processing</h4>
                </div>
								<div>
									<h4>Advanced Diploma in Networking</h4>
                </div>
								<div>
									<h4>Advance Diploma in French</h4>
                </div>
								<div>
									<h4>Advanced Diploma in German</h4>
                </div>
								<div>
									<h4>Advanced Diploma in Sanskrit</h4>
                </div>
