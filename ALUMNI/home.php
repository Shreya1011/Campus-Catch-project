...
<body style="background-color: #D0BCA1;">
    ...
    <div class="row justify-content-center">
     <div class="col-md-10 border-right">
        ...
        <form action="menu.php" class="form1" method="POST" enctype="multipart/form-data">
            ...
            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                        <label for="profile-picture">
                            <div class="d-flex flex-column align-items-center">
                                <img id="uploaded-image" class="rounded-circle mt-5" width="130px" src="https://cdn1.vectorstock.com/i/1000x1000/52/65/female-student-graduation-avatar-profile-vector-12055265.jpg">
                                <span class="font-weight-bold mt-3">Alumni Updated Photo</span>
        ...
        <!--<div class="d-flex justify-content-center align-items-center vh-100">-->
                        ...
                        <input required type="text" name="aluname" placeholder="Name" class="form-control mt-3">
                        <input type="email" name="Email" placeholder="E-mail_id" class="form-control mt-3">
                        <input type="mobile" name="contact_no" placeholder="mobile_no" class="form-control mt-3">
                        <input required type="integer" name="batch" placeholder="Batch" class="form-control mt-3">
                        <input required type="text" name="designation" placeholder="Designation" class="form-control mt-3">
                        <input required type="text" name="Linkedln_Profile" placeholder="Linkedin_profile" class="form-control mt-3">
                        <input  type="text" name="Events_link" placeholder="Event Descrption" class="form-control mt-3">
                        
                        <input  type="text" name="Events_Management" placeholder="Event Link" class="form-control mt-3">
