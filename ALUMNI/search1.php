...
if (isset($_POST['search_query'])) {
    ...
    $sql_student = "SELECT sname as name,email,contact_no as mobile, Hostel as hostel, smartid as class,    course as Desig, impath,        Linkedin as lp,          details as eve,      cgpa as link,    'Student' as category FROM student WHERE sname LIKE '%$search_query%'";
    ...
    if ($result_student->num_rows > 0) {
        while($row = $result_student->fetch_assoc()) {
            echo "<div class='card'>
                    ...
                    <p>Smart ID: ".$row["class"]."</p>
                    <p>Hostel: ".$row["hostel"]."</p>
                    
                    <p>Course: ".$row["Desig"]."</p>
