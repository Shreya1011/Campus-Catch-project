  ...
  <div class="about-box">
    <div class="container">
        <div class="about about-grid">
          <h4>Team LOGOS</h4>
          <p>A Official open source club from department of computer Science,Apaji Institute,Banasthali Vidyapith</p>
          <p>Brigning the saga of technophilic nerds</p>
          ...
          <p> Website
            ...
            <p> Company size
               2-10 employees
             23 associated members LinkedIn members</p>
            <p>Founded
            2022</p>
          </div>
      ...
      <div class="team-grids">
        <div class="col-md-3 team-grid">
          <div class="team-img">
            ...
            <h4>Niharika Gupta</h4>
            <span>Seasonal Analyst'24 @GS | Ex- Research Intern @DRDO| Summer Analyst'23 @Goldman Sachs| B.Tech CS</span>
        </div>
        <div class="col-md-3 team-grid">
          <div class="team-img">
          ...
          <h4>Nupur Mishra</h4>
          <span>Junior @Banasthali Vidyapith| Technical Team Member @Algobyte Banasthali| B.tech CSE'25 |</span>
        </div>
        <div class="col-md-3 team-grid">
          <div class="team-img">
          ...
          <h4>Ananya Sharma</h4>
          <span>Graphic Core Team Member @Algobyte| Winner of open innovation Challenge @WEHack24| Lean In Banasthali Vidyapith Circle Member</span>
        </div>
        <div class="col-md-3 team-grid">
          <div class="team-img">
          ...
          <h4>Shilpi Mishra</h4>
          <span>Student at Banasthali Vidyapith| Graphic designing team member @Algobyte|Sub-Core Team member @samarthaya| B.V. CSE'25</span>
        </div>
        <div class="clearfix"></div>
      </div>
    </div>
