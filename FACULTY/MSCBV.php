    ...
    <div class="container">
        ...
        <div class="content about-grid">
          <div>
            <div class="img-box">
              <div class="about-img">
                <img src="image2/msc main1.jpeg" alt=""/>
              </div>
            </div>
            <div class="img-box">
              <div class="about-img">
                <img src="image2/msc main2.jpeg" alt=""/>
              </div>
            </div>
          ...
          <div class="about-top1">
            <div class="img-box">
              <div class="about-img">
                <img src="image2/msc main3.jpeg" alt=""/>
              </div>
            </div>
            <div class="img-box">
              <div class="about-img">
                <img src="image2/msc main4.jpeg" style="margin-bottom: 10rem;" alt=""/>
              </div>
            </div>
    ...
    <div class="container">
      ...
      <div class="team-grids">
        <div class="col-md-3 team-grid">
          <div class="team-img">
            <img src="image2/msc1.jpeg" class="img-responsive" alt=" " />
          </div>
            <h4>Anushka</h4>
            <span>| Banasthali Vidyapith'26| Bachelor's of Technology- CS-Artificial Intelligence| NCC B and C Certificate holder| PR Team Member @MSC - BV |</span>
        </div>
        <div class="col-md-3 team-grid">
          <div class="team-img">
            <img src="image2/msc2.jpeg" class="img-responsive" alt=" " />
          </div>
          <h4>Kinjal Pandey</h4>
          <span>| Banasthali Vidyapith'26| Bachelor's of Technology- CS-Artificial Intelligence| NCC B and C Certificate holder| PR Team Member @MSC - BV |</span>
        </div>
        <div class="col-md-3 team-grid">
          <div class="team-img">
            <img src="image2/msc3.jpeg" class="img-responsive" alt=" " />   
          </div>
          <h4>Mahika Trivedi</h4>
          <span>Design Team @Msc-BV || CSE || BV'27</span>
        </div>
        <div class="col-md-3 team-grid">
          <div class="team-img">
            <img src="image2/msc3.jpeg" class="img-responsive" alt=" " />   
