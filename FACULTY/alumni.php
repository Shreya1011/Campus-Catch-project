...
<body style="background-color: #D0BCA1;">
  ...
  <div class="search-container">
    ...
    <div>
      <input type="text" id="searchInput" class="search-input" placeholder="Search Alumni">
      <button onclick="searchAlumni()" class="search-button">Search</button>
    </div>
  </div>

  <div class="alumni-cards">
    <div class="card arts">
      <img src="alumimg/anuradhabhattacharya.jpg" alt="Alumni 1">
      <div class="card-content">
        <h3> Anuradha Bhattacharyya</h3>
        <p>Writer and Poet</p>
        <p>Course: Arts</p>
      </div>
    </div>
    <div class="card aviation">
      <img src="alumimg/avanichaturvedi.jpg" alt="Alumni 2">
      <div class="card-content">
        <h3>Avani Chaturvedi</h3>
        <p>Indian Pilot</p>
        <p>Batch: 2014</p>
        <p>Course: Aviation</p>
      </div>
    ...
    <div class="card arts">
      <img src="alumimg/kamlabeniwal.jpg" alt="Alumni 3">
      <div class="card-content">
        <h3>Kamla Beniwal</h3>
        <p>Indian Politician</p>
        <p>Former Deputy Chief Minister of Rajasthan</p>
        <p>Course: Arts</p>
      </div>
    </div>
    <div class="card arts">
      <img src="alumimg/meirakumar.jpg" alt="Alumni 4">
      <div class="card-content">
        <h3>Meira Kumar</h3>
        <p>Former Speaker of Lok Sabha</p>
        <p>Course: Arts</p>
      </div>
    </div>
    <div class="card arts">
      <img src="alumimg/sudeshdhankar.jpg" alt="Alumni 5">
      <div class="card-content">
        <h3> Sudesh Dhankar</h3>
        <p>Second Lady Of India</p>
        <p>Course: Arts</p>
      </div>
    </div>
  </div>
