...
<div class="courses-details">					
									<div>
										<h4>M.A</h4>
										<p>(Economics, History, Political Science, Sociology, Psychology, Geography, Sanskrit, Hindi, English, Drawing & Painting, Music (Instrumental), Music (Vocal), Kathak Dance, Textile Designing (Weaving), Textile Designing (Printing))</p>
									</div>
									...
									<div >
										<h4>M.Sc.</h4>
										<p>.(Physics, Chemistry, Computer Science, Data Science#, Mathematical Science, Electronics, Botany, Zoology, Bioinformatics, Biotechnology, Microbiology#, Applied Microbiology & Biotechnology,  Environmental Science, Geography, Geology)</p>
									</div>
				
									<div>
										<h4>M.Sc. (Home Science) </h4>
										<p>(Human Development, Food Science & Nutrition, Clothing & Textile)</p>
									</div>
									...
									<div>
										<h4>Post Graduate Diploma in Computer Applications (PGDCA)</h4>
									</div>
									...
									<div>
										<h4>M.Pharm.</h4>
										<p>(Pharmaceutical Chemistry/ Pharmaceutics/Pharmacology)</p>
									</div>
										
									<div>
										<h4>M.Tech.</h4>
										<p>(Computer Science / Artificial Intelligence# / Robotics & Automation# / VLSI Design /Information Technology/Remote Sensing/Bio-technology/Chemical Engineering/Nanotechnology/)</p>
									</div>
										
									<div>
										<h4>M.Phil</h4>
										<p>(Economics, Political Science, History, Geography, Sociology, English - Language Teaching, Hindi, Sanskrit, Indian Music, Drawing & Painting, Mathematical Sciences)</p>
									</div>
									...
									<div>
										<h4>Ph.D. </h4>
										<p>(Sanskrit, Philosophy and Vedic Studies, Hindi and Modern Indian Languages, English and Modern European Languages, , Economics, History and Indian Culture, Political Science and Public Administration, Sociology, Physical Education, Performing Arts, Visual Art, Computer Science, Electronics, Mathematical Science, Physics, Chemistry, Bio-science and Biotechnology, Home-science, Education, Commerce and Banking,  Management, Design, Pharmacy,Legal Studies, Psychology, Journalism and Mass Communication,Chemical Engineering,Earth Sciences, Aviation, Automation)</p>
									</div>
