...
echo "<p>Major domain: " . $row["domain"] . "</p>";

echo "<p>Drive link (For study materials) " . $row["drive"] . "</p>";
echo "<p>Department : " . $row["department"] . "</p>";
echo "<p>Researches : " . $row["research"] . "</p>";
echo "<p>Linkedin Profile : " . $row["Linkedin"] . "</p>";
echo "<p>Schedule:</p><img src='". $row['impath1'] ."' class='timetable-img'>";
echo "<hr>";
