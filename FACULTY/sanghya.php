  ...
  <div class="about-box">
    <div class="container">
        <div class="about about-grid">
          <h4>SANGEHA- The unheard Voices</h4>
          <p>A Official singing club in Banasthali Vidyapith</p>
      ...
      <div class="team-grids">
        <div class="col-md-3 team-grid">
          <div class="team-img">
            ...
            <h4>Manya Garg</h4>
            <span>Co-Lead - Sangeha| SSOC'23| Summer Analyst'23 @Goldman Sachs| B.Tech IT'25</span>
        </div>
        <div class="col-md-3 team-grid">
          <div class="team-img">
          ...
          <h4>Siddhi Shukla</h4>
          <span>Core team member of Sangeha| B.tech CSE'25 |</span>
        </div>
        <div class="col-md-3 team-grid">
          <div class="team-img">
