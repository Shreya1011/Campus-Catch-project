  ...
  <div class="about-box">
    <div class="container">
        <div class="about about-grid">
          <h4>GEEKS FOR GEEKS BV CHAPTER</h4>
          <p>With the idea of imparting programming knowledge to the students of the university.</p>
          ...
          <p> Website
            ...
            <p> Company size
            2-10 employees
            15 associated members LinkedIn members who’ve listed DSC Banasthali Vidyapith as their current workplace on their profile.</p>
            <p>Founded
            2022</p>
          </div>
        <div class="content about-grid">
          <div>
            <div class="img-box">
              <div class="about-img">
                <img src="image/gdsc11.jpeg" alt=""/>
              </div>
            </div>
            <div class="img-box">
              <div class="about-img">
                <img src="image/gdsc12.jpeg" alt=""/>
              </div>
            </div>
          ...
          <div class="about-top1">
            <div class="img-box">
              <div class="about-img">
                <img src="image/gdsc13.jpeg" alt=""/>
              </div>
            </div>
            <div class="img-box">
              <div class="about-img">
                <img src="image/gdsc14.jpeg" style="margin-bottom: 10rem;" alt=""/>
              </div>
            </div>
        ...
        <div class="container">
          ...
          <div class="principle-grids" style="margin-top: 5rem;">
            ...
            <div class="content principle-grid1">
              <div>
                <ul class="place">
                  <li><img src="image/cir.png" alt=""></li>
              ...
              <div class="tab3">
                <ul class="place">
                  <li><img src="image/cir.png" alt=""></li>
                  <li>Competitive Programming Resources</li>
                </ul>
              <!-- <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer ornare odio et massa dignissim, at accumsan metus viverra.</p> -->
              </div>
              <div class="tab4">
              ...
              <div class="tab5">
                <ul class="place">
                  <li><img src="image/cir.png" alt=""></li>
                  <li>Build Projects & Compete in the geeks gor geeks Challenge</li>
                </ul>
              <!-- <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer ornare odio et massa dignissim, at accumsan metus viverra.</p> -->
              </div>
    ...
    <div class="container">
      ...
      <div class="team-grids">
        <div class="col-md-3 team-grid">
          <div class="team-img">
            <img src="image/gdscteam1.jpeg" class="img-responsive" alt=" " />
          </div>
            <h4>Anvesha Dixit</h4>
            <span>Ex- SDE Intern @Essentia.dev | JPMC Code for Good'23 | EX-designer @Unstop | Geeks for Geeks Team Member | BV '24</span>
        </div>
        <div class="col-md-3 team-grid">
          <div class="team-img">
            <img src="image/gdscteam2.jpeg" class="img-responsive" alt=" " />
          </div>
        ...
        <div class="col-md-3 team-grid">
          <div class="team-img">
            <img src="image/gdscteam3.jpeg" class="img-responsive" alt=" " />   
          </div>
          <h4>Komal Sharma</h4>
        ...
        <div class="col-md-3 team-grid">
          <div class="team-img">
            <img src="image/gdscteam4.jpeg" class="img-responsive" alt=" " />
          </div>
