  ...
  <div class="about-box">
    <div class="container">
        <div class="about about-grid">
          <h4>WAPPERS</h4>
          <p>Official coding club of Banasthali Vidyapith,aim to estabish a coding culture in the campus, to reach every student passionate about coding</p>
         
          


          <p> Website
            https://www.codechef.com </p>
            <p>Industry
            Education Management</p>
            <p> Company size
               11-50 employees
             24 associated members LinkedIn members</p>
            <p>Founded
            2014</p>
          </div>
        ...
        <div class="container">
          ...
          <div class="principle-grids" style="margin-top: 5rem;">
            ...
            <div class="content principle-grid1">
              <div>
                <ul class="place">
                  <li><img src="image2/cir.png" alt=""></li>
                  <li>Offering essential tools for Programming Skills</li> </li>
                </ul>
    ...
    <div class="container">
      ...
      <div class="team-grids">
        <div class="col-md-3 team-grid">
          <div class="team-img">
            <img src="image2/wrappers1.jpeg" class="img-responsive" alt=" " />
          </div>
            <h4>Samprati Vishnoi</h4>
            <span>Incoming SWE @Atlassian | Ex-SWE Intern @Amazon | Ex-SWE Intern'23 @Atlassian | Flipkart GWC'23 | Coach[In] '22 | Founder & Ex-Lead @GFGxBV Chapter | JPMC Code For Good'22 | Lead @Wappers | Mentor @Codess.Cafe</span>
        </div>
        <div class="col-md-3 team-grid">
          <div class="team-img">
            <img src="image2/Wrappers2.jpeg" class="img-responsive" alt=" " />
          </div>
          <h4>Ekta Sahu</h4>
          <span>Former SDE Intern @Essentia Softserv LLP '23 | Former Summer Intern @Barclays '23 | Flipkart GWC 4.0 Mentee | Harvard WeCode Scholar' 22 | Team Lead @Codechef-BV Chapter | CSE' 24 @ Banasthali Vidhyapith</span>
        </div>
        <div class="col-md-3 team-grid">
          <div class="team-img">
            <img src="image2/Wappers3.jpeg" class="img-responsive" alt=" " />   
          </div>
          <h4>Ananya Singh</h4>
          <span>Upcoming SWE Intern @ Google | Talentsprint WE'22 Scholar | JPMC Code For Good'23 Finalist | GDSC Banasthali Vidyapith Team Member | CSE'25</span>
        </div>
        <div class="col-md-3 team-grid">
          <div class="team-img">
            <img src="image2/wappers 4.jpeg" class="img-responsive" alt=" " />
          </div>
          <h4>Muskan</h4>
          <span>Intern at DoIT&C |Executive Team Member at CodeChef Banasthali Chapter| GSSoC'22</span>
        </div>
        <div class="clearfix"></div>
      </div>
    </div>
