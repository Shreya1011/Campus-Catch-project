...
<head>
  ...
  <link rel="stylesheet" href="assets/css/style.css">
   ...
   <link href="css2/css/style.css" rel="stylesheet" type="text/css" media="all" />
</head>
<body style="background-color: #D0BCA1;">
  <header id="site-header" class="fixed-top">
    <div class="container">
      <nav class="navbar navbar-expand-lg navbar-dark stroke">
        <h1>
          <a class="navbar-brand" href="main.html">Campus Catch</a>
        </h1>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav ml-lg-auto">
              ...
              <li class="nav-item"><a class="nav-link" href="courses.html">Program List</a></li>
              <li class="nav-item"><a class="nav-link" href="main.html">Faculty</a></li>
  ...
  <section class="w3l-about-breadcrumb text-center">
    <div class="breadcrumb-bg breadcrumb-bg-about py-5" style="background: url(image/apaji-lights\ 1.jpeg);">
...
-->
  ...
  <div class="about-box">
    <div class="container">
        <div class="about about-grid">
          <h4>GOOGLE DEVELOPERS STUDENT CLUB</h4>
          <p>A Google Developers program for university students, with an aim to help students build their development skills.</p>

          <p> Website
            https://instagram.com/dsc_banasthalividyapith?igshid=r5jdmygo8ych </p>
            <p>Industry
            Education Administration Programs</p>
            <p> Company size
            1,001-5,000 employees
            57 associated members LinkedIn members who’ve listed DSC Banasthali Vidyapith as their current workplace on their profile.</p>
            <p>Founded
            2020</p>
          </div>
        <div class="content about-grid">
          <div>
            <div class="img-box">
              <div class="about-img">
                <img src="image2/gdsc11.jpeg" alt=""/>
              </div>
            </div>
            <div class="img-box">
              <div class="about-img">
                <img src="image2/gdsc12.jpeg" alt=""/>
              </div>
            </div>
          ...
          <div class="about-top1">
            <div class="img-box">
              <div class="about-img">
                <img src="image2/gdsc13.jpeg" alt=""/>
              </div>
            </div>
            <div class="img-box">
              <div class="about-img">
                <img src="image2/gdsc14.jpeg" style="margin-bottom: 10rem;" alt=""/>
              </div>
            </div>
      ...
      <div style="margin: 3rem 3rem;">
        <div class="container">
          <h3 class="tittle2" > Our Offerings</h3>
          <div class="principle-grids" style="margin-top: 5rem;">
            
            <div class="content principle-grid1">
              <div>
                <ul class="place">
                  <li><img src="css2/images/cir.png" alt=""></li>
                  <li>Hands-on Workshops </li>
                </ul>
                <!-- <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer ornare odio et massa dignissim, at accumsan metus viverra.</p> -->
              </div>
              <div class="tab2">
                <ul class="place">
                  <li><img src="css2/images/cir.png" alt=""></li>
  ...
  <div class="team">
    <div class="container">
      <h3 class="tittle2"> Our Team</h3>
      <div class="team-grids">
        <div class="col-md-3 team-grid">
          <div class="team-img">
            <img src="image2/gdscteam1.jpeg" class="img-responsive" alt=" " />
          </div>
            <h4>Ritika Thareja</h4>
            <span>Software Engineer @Optum | prev.- Software Engineer-L1 @Xebo.ai | Software Developer Intern @Essentia Softserv LLP | GDSC Banasthali Vidyapith Team Member | BV '23</span>
        </div>
        <div class="col-md-3 team-grid">
          <div class="team-img">
            <img src="image2/gdscteam2.jpeg" class="img-responsive" alt=" " />
          </div>
          <h4>Rimjhim Srivastava</h4>
          <span>Project Intern @lenskart | BV'24 | EE | GDSC member Banasthali Vidyapith</span>
        </div>
        <div class="col-md-3 team-grid">
          <div class="team-img">
            <img src="image2/gdscteam3.jpeg" class="img-responsive" alt=" " />   
          </div>
          <h4>Komal Sharma</h4>
          <span>Intern@ CDAC- Delhi | JPMC Code For Good'23 | Harvard WECode Scholar'22 | Team Member at GDSC Banasthali Vidyapith | 5⭐@HackerRank C++ | Lean In Banasthali Vidyapith Circle Member</span>
        </div>
        <div class="col-md-3 team-grid">
          <div class="team-img">
            <img src="image2/gdscteam4.jpeg" class="img-responsive" alt=" " />
          </div>
          <h4>Charu Srivastava</h4>
          <span>Upcoming SEP Intern @JP Morgan Chase & Co. | JPMC CfG'23 | HPAIR ACONF'22 Scholar | Technical & Content Team Member @GDSC- B.V. | B.V. CSE'25</span>
        </div>
        <div class="clearfix"></div>
      </div>
    </div>
